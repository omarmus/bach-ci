$(function(){
  ...
  window.MY_Socket = {
    ...
    bindEvents : function() {
      ...
      this.socket.on('userConnect', MY_Socket.userConnect);
      //this.socket.on('usersListConnect', MY_Socket.usersListConnect);
      this.socket.on('userDisconnect', MY_Socket.userDisconnect);
      this.socket.on('newMessageChat', MY_Socket.newMessageChat);
    },
    ...
    joinChat : function () {
      ...
      if(sessionId) {
        ...
        MY_Socket.socket.emit('joinChat',sessionId);
      } else {
    ...
    sendMessageChat : function (id_receiver, message, date) {
      MY_Socket.socket.emit('sendMessageChat', _my_user.id, id_receiver, message, date);
    }
