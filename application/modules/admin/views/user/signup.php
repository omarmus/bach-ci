...
<header class="navbar navbar-inverse navbar-fixed-top create-user" role="navigation">
    <div class="container">
    	<div class="navbar-header">
    		...
    		<a class="navbar-brand" href="<?php echo base_url('admin/dashboard') ?>" style="color: #FFFFFF;"><?php echo $site_name_ ?></a>
    	</div>
    	<nav class="collapse navbar-collapse navbar-ex1-collapse">
    		<div class="session-login visible-xs"><strong>Inicie su sesión</strong></div>
    	    <div class="navbar-form navbar-right">
    	    	<form method="post" class="signup" action="login">
...
<div class="container">
	<div class="row">
		<form id="form-create" action="signup" class="col-md-4 col-md-offset-7 col-sm-8 col-sm-offset-2" method="post">
			...
			<h3 class="form-signin-heading "><?php echo lang('sign_up') ?></h3>
			<div class="row">
