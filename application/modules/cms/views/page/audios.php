<?php echo modal_header($page->title . ' <small>' . lang('audios') . ' ' . (count($audios) ? '<strong id="count-items">(' . count($audios) . ')</strong>' : '') . '</small>') ?>
<div class="multimedia">
	...
	<?php endif ?>
	<?php echo form_close(); ?>
	<form id="form-audios" onsubmit="return validate_data(this, '<?php echo base_url() ?>cms/page/save_descriptions/', 'btn-save-files', null, save_textareas)">
